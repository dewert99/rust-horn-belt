...
Section time.
  ...
  Global Instance peristent_time_receipt_timeless n : Timeless (⧖n).
  Proof. unfold persistent_time_receipt. apply _. Qed.
  Global Instance peristent_time_receipt_persistent n : Persistent (⧖n).
  Proof. unfold persistent_time_receipt. apply _. Qed.
  ...
  Lemma persistent_time_receipt_sep n m :
    ⧖(n `max` m) ⊣⊢ ⧖n ∗ ⧖m.
...
Proof.
  ...
  iExists (TimeG _ _ _ time_global_name time_cumulative_name time_persistent_name).
